...
describe("selectionSort(arr, compare)", function() {
  it("should be able to sort arrays in ascending order", function() {
    chai.assert.deepEqual(
      selectionSort([6, 5, 3, 9, 7, 1, 2, 8, 4], ascend),
      [1, 2, 3, 4, 5, 6, 7, 8, 9]
    );
  });
  ...
  it("should be able to sort arrays in descending order", function() {
    chai.assert.deepEqual(
      selectionSort([6, 5, 3, 9, 7, 1, 2, 8, 4], descend),
      [9, 8, 7, 6, 5, 4, 3, 2, 1]
    );
  });
  ...
  it("should preverse array containing only duplicates", function() {
    ...
    chai.assert.deepEqual(selectionSort(vals, ascend), vals.slice());
  });
  ...
  it("should sort an abritary array", function() {
    ...
    chai.assert.deepEqual(selectionSort(vals, ascend), vals.slice().sort(ascend));
  });
});
